...
query y hệt `ADJUST_REPORT_QUERY` nhưng app_token = app **M002 - Saya**, `utc_offset=%2B07:00` khớp
account Meta Saya chính (GMT+7; dấu `+` phải encode `%2B`). `META_SAYA_AD_ACCOUNT_ID` nhận **nhiều
